...
The starter file, **Server.java**, is the simple Echo Server from class.  This provides the basic framework for creating your web server. Here is the [rubric](rubric.md) that will be used for grading the assignment.

**Refer to the Assigned Reading [Mozilla Developer Network MDN HTTP Documentation](https://developer.mozilla.org/en-US/docs/Web/HTTP) and the [HTTP Wikipedia page](https://en.wikipedia.org/wiki/HTTP) for HTTP/1.1 Request and Response headers and formatting guidelines.**
